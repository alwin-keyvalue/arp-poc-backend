...
_INTENT_TO_PAYLOAD_MODEL: dict[IntentType, Type[BaseModel]] = {
    IntentType.NEW_TASK: NewTaskPayload,
    IntentType.STATUS_UPDATE: StatusUpdatePayload,
    IntentType.DATE_UPDATE: DateUpdatePayload,
    IntentType.REASSIGNMENT: ReassignmentPayload,
...
class Analyzer:
    ...
    async def analyze(self, email: EmailInput) -> AnalyzeResponse:
